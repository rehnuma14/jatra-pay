...
```powershell
# create repo (already done for you) and push
gh repo create jatra-pay --public --source . --remote origin --push
...
---
Generated by your development assistant. Feel free to ask me to expand or adjust this README.